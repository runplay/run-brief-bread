...
public abstract class Db {
	...
	private static final String DATABASE_FILE=Files.HOME_PATH_FILES+File.separator+"Bread.db";
	...
	//public boolean isFirstTimeRun=false;
    ...
    private DatabaseErrorHandler bderrorhandler = new DatabaseErrorHandler() {
        ...
        public void onCorruption(SQLiteDatabase sqLiteDatabase) {
            //BLog.e("DBERROR","returns db errorrrrrrrrrrrrrrrrrrrrrr");
        }
    };
