...
public final class State {
    ...
    public static final int SECTION_NEWS=7;
    public static final int SECTION_NEWS_VIEW=13;
    public static final int SECTION_NEWS_CHOOSE=21;
	...
	public static final int SECTION_NEWS_WEBVIEW =1028;
